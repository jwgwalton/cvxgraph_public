...
def plot_results(results,save_location):
  ...
  plt.xlabel('Number of perturbed eigenvalues',fontsize=20)
...
def plot_graph(graph_name):
  file_location = 'results/'+graph_name+'_eigenvalue_count_small_pertubation.txt'
  figure_location='figures/'+graph_name+'_eigenvalue_count_small_pertubation.pdf'
