...
import cvxpy as cvx
import numpy as np
from constraints.degree_hull_constraint import DegreeHullConstraint
...
class GraphDeconvolver:
  ...
  def deconvolve(self, A):
    ...
    A1_hull = DegreeHullConstraint(self.A1, A1_labelled)
    A2_hull = DegreeHullConstraint(self.A2, A2_labelled)
